    ...
    <div class="max-w-xl mx-auto px-4 sm:px-6 py-20 text-center">
        @if($done)
            ...
            <p class="mt-3 text-gray-600 dark:text-gray-400">
                No volverás a recibir el resumen semanal en {{ $email }}.
                @auth
                    Los avisos sobre tus propias skills (aprobaciones, comentarios) se gestionan aparte desde tu perfil.
                @endauth
            </p>
        ...
        @else
            ...
            <p class="mt-3 text-gray-600 dark:text-gray-400">
                Dejarás de recibir el email de los lunes con las skills y guías nuevas en {{ $email }}.
            </p>
